...
*/
	...
	.value("whirlpool", libdar::hash_algo::whirlpool)
	.value("sha3_512", libdar::hash_algo::sha3_512)
	.value("blake2b_512", libdar::hash_algo::blake2b_512);

    pybind11::enum_<libdar::rsync_sig_magic>(mod, "rsync_sig_magic")
	.value("none", libdar::rsync_sig_magic::none)
	.value("md4", libdar::rsync_sig_magic::md4)
	.value("blake2", libdar::rsync_sig_magic::blake2)
	.value("rk_blake2", libdar::rsync_sig_magic::rk_blake2);
	...
	.value("zstd", libdar::compression::zstd)
	.value("lz4", libdar::compression::lz4);
	...
	.def("set_multi_threaded_crypto", &libdar::archive_options_read::set_multi_threaded_crypto)
	.def("set_multi_threaded_compress", &libdar::archive_options_read::set_multi_threaded_compress)
	...
	.def("set_compression_block_size", &libdar::archive_options_create::set_compression_block_size)
	...
	.def("set_multi_threaded_crypto", &libdar::archive_options_create::set_multi_threaded_crypto)
	.def("set_multi_threaded_compress", &libdar::archive_options_create::set_multi_threaded_compress)
	.def("set_delta_diff", &libdar::archive_options_create::set_delta_diff)
	.def("set_delta_signature", static_cast<void (libdar::archive_options_create::*)(libdar::rsync_sig_magic)>(&libdar::archive_options_create::set_delta_signature))
	.def("set_delta_signature", static_cast<void (libdar::archive_options_create::*)(bool)>(&libdar::archive_options_create::set_delta_signature))
	...
	.def("set_compression_block_size", &libdar::archive_options_isolate::set_compression_block_size)
	...
	.def("set_multi_threaded_crypto", &libdar::archive_options_isolate::set_multi_threaded_crypto)
	.def("set_multi_threaded_compress", &libdar::archive_options_isolate::set_multi_threaded_compress)
	.def("set_delta_signature", static_cast<void (libdar::archive_options_isolate::*)(libdar::rsync_sig_magic)>(&libdar::archive_options_isolate::set_delta_signature))
	.def("set_delta_signature", static_cast<void (libdar::archive_options_isolate::*)(bool)>(&libdar::archive_options_isolate::set_delta_signature))
	...
	.def("set_compression_block_size", &libdar::archive_options_merge::set_compression_block_size)
	...
	.def("set_mutli_threaded_crypto", &libdar::archive_options_merge::set_multi_threaded_crypto)
	.def("set_multi_threaded_compress", &libdar::archive_options_merge::set_multi_threaded_compress)
	.def("set_delta_signature", static_cast<void (libdar::archive_options_merge::*)(libdar::rsync_sig_magic)>(&libdar::archive_options_merge::set_delta_signature))
	.def("set_delta_signature", static_cast<void (libdar::archive_options_merge::*)(bool)>(&libdar::archive_options_merge::set_delta_signature))
	...
	.def("set_multi_threaded_crypto", &libdar::archive_options_repair::set_multi_threaded_crypto)
	.def("set_multi_threaded_compress", &libdar::archive_options_repair::set_multi_threaded_compress);
	...
	.def("get_slice_number", &libdar::archive_summary::get_slice_number,pybind11::return_value_policy::reference_internal)
	.def("get_archive_size", &libdar::archive_summary::get_archive_size, pybind11::return_value_policy::reference_internal)
	.def("get_catalog_size", &libdar::archive_summary::get_catalog_size, pybind11::return_value_policy::reference_internal)
	.def("get_storage_size", &libdar::archive_summary::get_storage_size, pybind11::return_value_policy::reference_internal)
	.def("get_data_size", &libdar::archive_summary::get_data_size, pybind11::return_value_policy::reference_internal)
	.def("get_contents", &libdar::archive_summary::get_contents, pybind11::return_value_policy::reference_internal)
	...
	.def("get_uid", &libdar::list_entry::get_uid, pybind11::arg("try_resoling_name") = false)
	.def("get_gid", &libdar::list_entry::get_gid, pybind11::arg("try_resoling_name") = false)
	...
	.def("has_delta_signature", static_cast<bool (libdar::list_entry::*)() const>(&libdar::list_entry::has_delta_signature))
	.def("has_delta_signature", static_cast<bool (libdar::list_entry::*)(libdar::rsync_sig_magic &) const>(&libdar::list_entry::has_delta_signature))
