...
namespace libdar
{
    ...
    {
    public:
	crypto_sym(const secu_string & password, ///< cipher password
		   const archive_version & reading_ver, ///< archive format version
		   crypto_algo algo,         ///< ciphering algorithm to use
		   const std::string & salt, ///< if set empty, the salt is generated by the crypto_sym when use_pkcs5 is set to true, else it is not used
