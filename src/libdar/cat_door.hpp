...
namespace libdar
{
	...
	cat_door(cat_door && ref) noexcept = default;
	cat_door & operator = (const cat_door & ref) = default;
	cat_door & operator = (cat_door && ref) noexcept = default;
	~cat_door() = default;

	virtual bool operator == (const cat_entree & ref) const override;

        virtual cat_signature signature() const override { return cat_signature('o', get_saved_status()); };
