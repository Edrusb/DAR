...
namespace libdar
{
    ...
    {
	x_crypto = std::move(ref.x_crypto);
	x_pass = std::move(ref.x_pass);
	x_crypto_size = std::move(ref.x_crypto_size);
	x_input_pipe = std::move(ref.x_input_pipe);
	x_output_pipe = std::move(ref.x_output_pipe);
	x_execute = std::move(ref.x_execute);
	x_info_details = std::move(ref.x_info_details);
	x_lax = std::move(ref.x_lax);
	x_sequential_read = std::move(ref.x_sequential_read);
	x_slice_min_digits = std::move(ref.x_slice_min_digits);
	x_entrepot = std::move(ref.x_entrepot);
	x_ignore_signature_check_failure = std::move(ref.x_ignore_signature_check_failure);
	x_multi_threaded_crypto = std::move(ref.x_multi_threaded_crypto);
	x_multi_threaded_compress = std::move(ref.x_multi_threaded_compress);
	x_header_only = std::move(ref.x_header_only);
	x_silent = std::move(ref.x_silent);
	x_early_memory_release = std::move(ref.x_early_memory_release);
	x_force_first_slice = std::move(ref.x_force_first_slice);

	    //

	external_cat = std::move(ref.external_cat);
	x_ref_chem = std::move(ref.x_ref_chem);
	x_ref_basename = std::move(ref.x_ref_basename);
	x_ref_crypto = std::move(ref.x_ref_crypto);
	x_ref_pass = std::move(ref.x_ref_pass);
	x_ref_crypto_size = std::move(ref.x_ref_crypto_size);
	...
	x_entrepot = ref.x_entrepot;
	x_ref_arch = std::move(ref.x_ref_arch);
	x_allow_over = std::move(ref.x_allow_over);
	x_warn_over = std::move(ref.x_warn_over);
	x_info_details = std::move(ref.x_info_details);
	x_display_treated = std::move(ref.x_display_treated);
	x_display_treated_only_dir = std::move(ref.x_display_treated_only_dir);
	x_display_skipped = std::move(ref.x_display_skipped);
	x_display_finished = std::move(ref.x_display_finished);
	x_pause = std::move(ref.x_pause);
	x_empty_dir = std::move(ref.x_empty_dir);
	x_compr_algo = std::move(ref.x_compr_algo);
	x_compression_level = std::move(ref.x_compression_level);
	x_compression_block_size = std::move(ref.x_compression_block_size);
	x_file_size = std::move(ref.x_file_size);
	x_first_file_size = std::move(ref.x_first_file_size);
	x_execute = std::move(ref.x_execute);
	x_crypto = std::move(ref.x_crypto);
	x_pass = std::move(ref.x_pass);
	x_crypto_size = std::move(ref.x_crypto_size);
	x_gnupg_recipients = std::move(ref.x_gnupg_recipients);
	x_gnupg_signatories = std::move(ref.x_gnupg_signatories);
	x_min_compr_size = std::move(ref.x_min_compr_size);
	x_nodump = std::move(ref.x_nodump);
	x_what_to_check = std::move(ref.x_what_to_check);
	x_hourshift = std::move(ref.x_hourshift);
	x_empty = std::move(ref.x_empty);
	x_alter_atime = std::move(ref.x_alter_atime);
	x_old_alter_atime = std::move(ref.x_old_alter_atime);
	x_furtive_read = std::move(ref.x_furtive_read);
	x_same_fs = std::move(ref.x_same_fs);
	x_same_fs_include = std::move(ref.x_same_fs_include);
	x_same_fs_exclude = std::move(ref.x_same_fs_exclude);
	x_snapshot = std::move(ref.x_snapshot);
	x_cache_directory_tagging = std::move(ref.x_cache_directory_tagging);
	x_fixed_date = std::move(ref.x_fixed_date);
	x_slice_permission = std::move(ref.x_slice_permission);
	x_slice_user_ownership = std::move(ref.x_slice_user_ownership);
	x_slice_group_ownership = std::move(ref.x_slice_group_ownership);
	x_repeat_count = std::move(ref.x_repeat_count);
	x_repeat_byte = std::move(ref.x_repeat_byte);
	x_sequential_marks = std::move(ref.x_sequential_marks);
	x_sparse_file_min_size = std::move(ref.x_sparse_file_min_size);
	x_security_check = std::move(ref.x_security_check);
	x_user_comment = std::move(ref.x_user_comment);
	x_hash = std::move(ref.x_hash);
	x_slice_min_digits = std::move(ref.x_slice_min_digits);
	x_backup_hook_file_execute = std::move(ref.x_backup_hook_file_execute);
	x_ignore_unknown = std::move(ref.x_ignore_unknown);
	x_scope = std::move(ref.x_scope);
	x_multi_threaded_crypto = std::move(ref.x_multi_threaded_crypto);
	x_multi_threaded_compress = std::move(ref.x_multi_threaded_compress);
	x_delta_diff = std::move(ref.x_delta_diff);
	x_delta_signature = std::move(ref.x_delta_signature);
	x_delta_mask = std::move(ref.x_delta_mask->clone());
	has_delta_mask_been_set = std::move(ref.has_delta_mask_been_set);
	x_delta_sig_min_size = std::move(ref.x_delta_sig_min_size);
	x_auto_zeroing_neg_dates = std::move(ref.x_auto_zeroing_neg_dates);
	x_ignored_as_symlink = std::move(ref.x_ignored_as_symlink);
	x_modified_data_detection = std::move(ref.x_modified_data_detection);
	...
	x_min_compr_size = std::move(ref.x_min_compr_size);
	x_empty = std::move(ref.x_empty);
	x_keep_compressed = std::move(ref.x_keep_compressed);
	x_slice_permission = std::move(ref.x_slice_permission);
	x_slice_user_ownership = std::move(ref.x_slice_user_ownership);
	x_slice_group_ownership = std::move(ref.x_slice_group_ownership);
	x_decremental = std::move(ref.x_decremental);
	x_sequential_marks = std::move(ref.x_sequential_marks);
	x_sparse_file_min_size = std::move(ref.x_sparse_file_min_size);
	x_user_comment = std::move(ref.x_user_comment);
	x_hash = std::move(ref.x_hash);
	...
	x_display_treated_only_dir = std::move(ref.x_display_treated_only_dir);
	x_display_skipped = std::move(ref.x_display_skipped);
	x_flat = std::move(ref.x_flat);
	x_what_to_check = std::move(ref.x_what_to_check);
	x_warn_remove_no_match = std::move(ref.x_warn_remove_no_match);
	x_empty = std::move(ref.x_empty);
	x_empty_dir = std::move(ref.x_empty_dir);
	x_dirty = std::move(ref.x_dirty);
	x_only_deleted = std::move(ref.x_only_deleted);
	x_ignore_deleted = std::move(ref.x_ignore_deleted);
	x_scope = std::move(ref.x_scope);
	x_ignore_unix_sockets = std::move(ref.x_ignore_unix_sockets);
	x_in_place = std::move(ref.x_in_place);
    }
	...
	x_info_details = std::move(ref.x_info_details);
	x_filter_unsaved = std::move(ref.x_filter_unsaved);
	x_slicing_location = std::move(ref.x_slicing_location);
	x_display_ea = std::move(ref.x_display_ea);
    }
	...
	x_furtive_read = std::move(ref.x_furtive_read);
	x_hourshift = std::move(ref.x_hourshift);
	x_compare_symlink_date = std::move(ref.x_compare_symlink_date);
	x_scope = std::move(ref.x_scope);
	x_in_place = std::move(ref.x_in_place);
	x_auto_zeroing_neg_dates = std::move(ref.x_auto_zeroing_neg_dates);
    }
