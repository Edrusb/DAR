...
/*********************************************************************/
// $Id: macro_tools.cpp,v 1.25 2005/12/29 02:32:41 edrusb Rel $
//
/*********************************************************************/
...
namespace libdar
{
    ...
    const dar_version macro_tools_supported_version = "05";
					      ...
					      U_32 crypto_size)
    {
        ...
        {
            path where = chemin;
            macro_tools_open_archive(dialog, where, base, extension, crypto, pass, crypto_size,
    ...
    {
        static char id[]="$Id: macro_tools.cpp,v 1.25 2005/12/29 02:32:41 edrusb Rel $";
        dummy_call(id);
    }
