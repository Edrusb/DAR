...
namespace libdar
{
    ...
    const archive_version archive_format_supported_version = archive_version(12,0);
	...
	case rsync_sig_magic::none:
	    throw SRC_BUG; // none is used internally and should thus not be exposed to user
