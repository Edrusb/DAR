...
namespace libdar
{
	...
	/// \param[in] p the memory pool to use for dynamic allocation of NULL to not used any memory pool
	...
	/// \param[in] p points to the memory pool to use or is to be set to NULL for no pool utilisation
