...
namespace libdar
{
	...
	{
#if LIBDAR_TIME_READ_ACCURACY == US || LIBDAR_TIME_READ_ACCURACY == NS
	    return true;
#else
	    return false;
#endif
	...
	{
#if LIBDAR_TIME_READ_ACCURACY == NS
	    return true;
#else
	    return false;
#endif
	...
	{
#if LIBDAR_TIME_WRITE_ACCURACY == US || LIBDAR_TIME_WRITE_ACCURACY == NS
	    return true;
#else
	    return false;
#endif
	...
	{
#if LIBDAR_TIME_WRITE_ACCURACY == NS
	    return true;
#else
	    return false;
#endif
