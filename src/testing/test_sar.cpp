...
static void f2()
{
    ...
    try
    {
        sar sar2(ui, "destination", "txt", where, 0, false, nullptr, false);
...
static void f3()
{
    ...
    try
    {
        sar sar3(ui, "destination", "txt", where, 0, false, nullptr, false);
        fichier_local src = fichier_local(ui, "./test/source.txt", gf_read_only, 0666, false, false, false);
...
void f4()
{
    ...
    try
    {
        sar sar2(ui, "destination", "txt", where, 0, true, nullptr, false, "echo SLICE %n");
