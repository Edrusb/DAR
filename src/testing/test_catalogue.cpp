...
void f1()
{
	...
	*pdesc = &stack;
        ...
        cat_file *v_file = new cat_file(1024, 102, 0644, datetime(1), datetime(2), datetime(3), "fichier", path(".") , 1024, 0, false);
...
void f3()
{
    ...
    dif.add(new cat_file(1024, 102, 0644, datetime(1), datetime(2), datetime(3), "fichier", path("."),  1024, 0, false));
