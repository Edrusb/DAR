...
protected :
    ...
    int inherited_write(const char *a, size_t size) { return (this->*write_ptr)(a, size); };
...
private :
    ...
    int (compressor::*write_ptr) (const char *a, size_t size);
    int none_write(const char *a, size_t size);
    int gzip_write(const char *a, size_t size);
	// int zip_write(const char *a, size_t size);
	// int bzip2_write(const char *a, size_t size);
};
