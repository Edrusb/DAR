...
#######################################################################
## $Id: Makefile,v 1.34.2.3 2003/05/19 20:48:04 edrusb Exp $
##
#######################################################################
...
### if you want to use the EXT2 NODUMP flag feature uncomment the following
USE_NODUMP_FEATURE = "yes"
...
### you pick the "dar" binary you would also need to pick the library that it
...
### library integrated in the binary and is called "dar_static"
### This version can be picked up in place of dar to be stored with your backup
...
ifdef USE_NODUMP_FEATURE
USE_NODUMP = -DNO_DUMP_FEATURE
else
USE_NODUMP =
endif

CPPFLAGS_COMMON = $(OPTIMIZATION) $(FILEOFFSET) $(USE_SYS_SIGLIST) $(FORCE_OS_BITS) $(USE_NODUMP) -Wall # -pedantic # -DTEST_MEMORY
...
OBJ = storage.o infinint.o deci.o erreurs.o generic_file.o compressor.o user_interaction.o sar.o header.o tools.o path.o mask.o tronc.o catalogue.o filesystem.o filtre.o dar.o command_line.o terminateur.o defile.o test_memory.o ea.o ea_filesystem.o header_version.o sar_tools.o tuyau.o zapette.o dar_suite.o scrambler.o etage.o macro_tools.o no_comment.o hide_file.o config_file.o wrapperlib.o
...
OBJ_MANAGER = data_tree.o database.o database_header.o dar_manager.o generic_file.o user_interaction.o erreurs.o path.o tools.o macro_tools.o infinint.o storage.o header.o header_version.o deci.o sar_tools.o sar.o dar_suite.o catalogue.o compressor.o tuyau.o zapette.o scrambler.o ea.o tronc.o terminateur.o test_memory.o wrapperlib.o
LIBS_MANAGER = $(LIBS_COMMON)
ALL_SRC = storage.cpp infinint.cpp deci.cpp erreurs.cpp generic_file.cpp compressor.cpp user_interaction.cpp sar.cpp header.cpp tools.cpp path.cpp mask.cpp tronc.cpp catalogue.cpp filesystem.cpp filtre.cpp dar.cpp command_line.cpp terminateur.cpp defile.cpp test_memory.cpp ea.cpp ea_filesystem.cpp header_version.cpp test_deci.cpp test_infinint.cpp factoriel.cpp test_erreurs.cpp test_compressor.cpp test_sar.cpp test_path.cpp test_mask.cpp test_tronc.cpp test_catalogue.cpp test_filesystem.cpp testtools.cpp test_terminateur.cpp dar_xform.cpp sar_tools.cpp dar_suite.cpp tuyau.cpp dar_slave.cpp zapette.cpp test_tuyau.cpp scrambler.cpp test_scrambler.cpp etage.cpp data_tree.cpp macro_tools.cpp database.cpp database_header.cpp dar_manager.cpp prime.cpp no_comment.cpp test_hide_file.cpp hide_file.cpp config_file.cpp wrapperlib.cpp
...
test_erreurs : test_erreurs.o erreurs.o infinint.o deci.o generic_file.o storage.o tools.o path.o user_interaction.o tuyau.o
	$(CXX) $(LDFLAGS) erreurs.o test_erreurs.o infinint.o deci.o generic_file.o storage.o tools.o path.o user_interaction.o tuyau.o $(LIBS) -o $@

test_compressor : compressor.o deci.o erreurs.o storage.o infinint.o generic_file.o path.o tools.o test_compressor.o user_interaction.o test_memory.o tuyau.o wrapperlib.o
	$(CXX) $(LDFLAGS) compressor.o deci.o erreurs.o storage.o infinint.o generic_file.o path.o tools.o test_compressor.o user_interaction.o test_memory.o tuyau.o wrapperlib.o $(LIBS) -o $@
...
test_catalogue : catalogue.o header_version.o ea.o test_catalogue.o erreurs.o storage.o infinint.o generic_file.o path.o tools.o tronc.o user_interaction.o deci.o test_memory.o tuyau.o compressor.o mask.o wrapperlib.o
	$(CXX) $(LDFLAGS) catalogue.o header_version.o ea.o erreurs.o storage.o infinint.o generic_file.o path.o tools.o tronc.o user_interaction.o deci.o test_catalogue.o test_memory.o tuyau.o compressor.o mask.o wrapperlib.o $(LIBS) -o $@

test_filesystem : filesystem.o test_filesystem.o erreurs.o storage.o infinint.o generic_file.o path.o tools.o catalogue.o user_interaction.o tronc.o deci.o test_memory.o ea_filesystem.o ea.o header_version.o tuyau.o compressor.o etage.o mask.o wrapperlib.o
	$(CXX) $(LDFLAGS) filesystem.o erreurs.o storage.o infinint.o generic_file.o path.o tools.o catalogue.o user_interaction.o tronc.o deci.o test_filesystem.o test_memory.o ea_filesystem.o ea.o header_version.o tuyau.o compressor.o etage.o mask.o wrapperlib.o $(LIBS) -o $@
...
test_hide_file : infinint.o storage.o path.o generic_file.o test_hide_file.o erreurs.o tools.o user_interaction.o deci.o tuyau.o no_comment.o hide_file.o config_file.o
	$(CXX) $(LDFLAGS) infinint.o storage.o path.o generic_file.o test_hide_file.o erreurs.o tools.o user_interaction.o deci.o tuyau.o no_comment.o hide_file.o config_file.o $(LIBS) -o $@
...
erreurs.o: infinint.hpp storage.hpp erreurs.hpp integers.hpp deci.hpp
generic_file.o: cygwin_adapt.hpp generic_file.hpp infinint.hpp storage.hpp erreurs.hpp integers.hpp path.hpp tools.hpp tuyau.hpp user_interaction.hpp
compressor.o: compressor.hpp generic_file.hpp infinint.hpp storage.hpp erreurs.hpp integers.hpp path.hpp wrapperlib.hpp
user_interaction.o: cygwin_adapt.hpp user_interaction.hpp erreurs.hpp integers.hpp tools.hpp path.hpp generic_file.hpp infinint.hpp storage.hpp tuyau.hpp
sar.o: cygwin_adapt.hpp sar.hpp generic_file.hpp infinint.hpp storage.hpp erreurs.hpp integers.hpp path.hpp header.hpp deci.hpp user_interaction.hpp tools.hpp tuyau.hpp test_memory.hpp
...
catalogue.o: tools.hpp path.hpp erreurs.hpp integers.hpp generic_file.hpp infinint.hpp storage.hpp tuyau.hpp catalogue.hpp header_version.hpp ea.hpp compressor.hpp wrapperlib.hpp mask.hpp tronc.hpp user_interaction.hpp deci.hpp header.hpp
filesystem.o: cygwin_adapt.hpp tools.hpp path.hpp erreurs.hpp integers.hpp generic_file.hpp infinint.hpp storage.hpp tuyau.hpp filesystem.hpp catalogue.hpp header_version.hpp ea.hpp compressor.hpp wrapperlib.hpp mask.hpp etage.hpp user_interaction.hpp ea_filesystem.hpp
filtre.o: user_interaction.hpp erreurs.hpp integers.hpp filtre.hpp mask.hpp path.hpp compressor.hpp generic_file.hpp infinint.hpp storage.hpp wrapperlib.hpp catalogue.hpp header_version.hpp tools.hpp tuyau.hpp ea.hpp filesystem.hpp etage.hpp defile.hpp test_memory.hpp null_file.hpp
dar.o: erreurs.hpp integers.hpp generic_file.hpp infinint.hpp storage.hpp path.hpp mask.hpp user_interaction.hpp terminateur.hpp compressor.hpp wrapperlib.hpp command_line.hpp catalogue.hpp header_version.hpp tools.hpp tuyau.hpp ea.hpp sar.hpp header.hpp filtre.hpp defile.hpp deci.hpp test_memory.hpp dar.hpp sar_tools.hpp dar_suite.hpp zapette.hpp scrambler.hpp macro_tools.hpp
command_line.o: cygwin_adapt.hpp deci.hpp storage.hpp erreurs.hpp integers.hpp infinint.hpp command_line.hpp compressor.hpp generic_file.hpp path.hpp wrapperlib.hpp mask.hpp user_interaction.hpp tools.hpp tuyau.hpp dar.hpp dar_suite.hpp etage.hpp no_comment.hpp hide_file.hpp config_file.hpp dar.usage
terminateur.o: terminateur.hpp generic_file.hpp infinint.hpp storage.hpp erreurs.hpp integers.hpp path.hpp
defile.o: defile.hpp catalogue.hpp infinint.hpp storage.hpp erreurs.hpp integers.hpp path.hpp generic_file.hpp header_version.hpp tools.hpp tuyau.hpp ea.hpp compressor.hpp wrapperlib.hpp mask.hpp
...
test_infinint.o: infinint.hpp storage.hpp erreurs.hpp integers.hpp deci.hpp cygwin_adapt.hpp test_memory.hpp
factoriel.o: cygwin_adapt.hpp infinint.hpp storage.hpp erreurs.hpp integers.hpp deci.hpp test_memory.hpp generic_file.hpp path.hpp
test_erreurs.o: erreurs.hpp integers.hpp
test_compressor.o: cygwin_adapt.hpp compressor.hpp generic_file.hpp infinint.hpp storage.hpp erreurs.hpp integers.hpp path.hpp wrapperlib.hpp test_memory.hpp
...
test_tronc.o: cygwin_adapt.hpp tronc.hpp generic_file.hpp infinint.hpp storage.hpp erreurs.hpp integers.hpp path.hpp deci.hpp testtools.hpp user_interaction.hpp
test_catalogue.o: testtools.hpp infinint.hpp storage.hpp erreurs.hpp integers.hpp generic_file.hpp path.hpp catalogue.hpp header_version.hpp tools.hpp tuyau.hpp ea.hpp compressor.hpp wrapperlib.hpp mask.hpp user_interaction.hpp test_memory.hpp macro_tools.hpp scrambler.hpp
test_filesystem.o: cygwin_adapt.hpp filesystem.hpp catalogue.hpp infinint.hpp storage.hpp erreurs.hpp integers.hpp path.hpp generic_file.hpp header_version.hpp tools.hpp tuyau.hpp ea.hpp compressor.hpp wrapperlib.hpp mask.hpp etage.hpp user_interaction.hpp test_memory.hpp
...
test_terminateur.o: cygwin_adapt.hpp terminateur.hpp generic_file.hpp infinint.hpp storage.hpp erreurs.hpp integers.hpp path.hpp deci.hpp test_memory.hpp
...
sar_tools.o: cygwin_adapt.hpp erreurs.hpp integers.hpp user_interaction.hpp sar.hpp generic_file.hpp infinint.hpp storage.hpp path.hpp header.hpp tools.hpp tuyau.hpp
dar_suite.o: dar_suite.hpp user_interaction.hpp erreurs.hpp integers.hpp test_memory.hpp
tuyau.o: cygwin_adapt.hpp tuyau.hpp generic_file.hpp infinint.hpp storage.hpp erreurs.hpp integers.hpp path.hpp tools.hpp user_interaction.hpp
...
data_tree.o: data_tree.hpp generic_file.hpp infinint.hpp storage.hpp erreurs.hpp integers.hpp path.hpp catalogue.hpp header_version.hpp tools.hpp tuyau.hpp ea.hpp compressor.hpp wrapperlib.hpp mask.hpp user_interaction.hpp
macro_tools.o: macro_tools.hpp catalogue.hpp infinint.hpp storage.hpp erreurs.hpp integers.hpp path.hpp generic_file.hpp header_version.hpp tools.hpp tuyau.hpp ea.hpp compressor.hpp wrapperlib.hpp mask.hpp scrambler.hpp terminateur.hpp user_interaction.hpp zapette.hpp sar.hpp header.hpp dar_suite.hpp
database.o: database.hpp catalogue.hpp infinint.hpp storage.hpp erreurs.hpp integers.hpp path.hpp generic_file.hpp header_version.hpp tools.hpp tuyau.hpp ea.hpp compressor.hpp wrapperlib.hpp mask.hpp data_tree.hpp user_interaction.hpp deci.hpp
database_header.o: cygwin_adapt.hpp database_header.hpp generic_file.hpp infinint.hpp storage.hpp erreurs.hpp integers.hpp path.hpp compressor.hpp wrapperlib.hpp tools.hpp tuyau.hpp user_interaction.hpp
dar_manager.o: dar_suite.hpp database_header.hpp generic_file.hpp infinint.hpp storage.hpp erreurs.hpp integers.hpp path.hpp macro_tools.hpp catalogue.hpp header_version.hpp tools.hpp tuyau.hpp ea.hpp compressor.hpp wrapperlib.hpp mask.hpp scrambler.hpp data_tree.hpp database.hpp test_memory.hpp user_interaction.hpp dar_manager.usage
prime.o: infinint.hpp storage.hpp erreurs.hpp integers.hpp deci.hpp
no_comment.o: no_comment.hpp hide_file.hpp generic_file.hpp infinint.hpp storage.hpp erreurs.hpp integers.hpp path.hpp
test_hide_file.o: cygwin_adapt.hpp no_comment.hpp hide_file.hpp generic_file.hpp infinint.hpp storage.hpp erreurs.hpp integers.hpp path.hpp config_file.hpp
hide_file.o: hide_file.hpp generic_file.hpp infinint.hpp storage.hpp erreurs.hpp integers.hpp path.hpp
config_file.o: config_file.hpp hide_file.hpp generic_file.hpp infinint.hpp storage.hpp erreurs.hpp integers.hpp path.hpp tools.hpp tuyau.hpp
wrapperlib.o: erreurs.hpp integers.hpp wrapperlib.hpp
