...
Source: http://dar.linux.free.fr/dar-2.0.2.tar.gz
URL: http://dar.linux.free.fr/
BuildRoot: %{_tmppath}/%{name}32-%{version}-%{release}-root
...
%build
./configure --enable-os-bits=32 --enable-mode=32 --prefix=/usr --mandir=/usr/share/man
make
...
/usr/lib/libdar32.so.1.0.2
/usr/lib/libdar32.so.1
/usr/lib/libdar32.so
/usr/lib/libdar32.la
/usr/lib/libdar32.a
