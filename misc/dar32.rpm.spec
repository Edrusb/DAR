...
Source: http://dar.linux.free.fr/dar-2.3.0_dev.tar.gz
...
%build
./configure  CXXFLAGS=-O --enable-mode=32 --prefix=/usr --mandir=/usr/share/man
make
...
/usr/lib/libdar32.so.4.0.0
/usr/lib/libdar32.so.4
/usr/lib/libdar32.so
/usr/lib/libdar32.la
/usr/lib/libdar32.a
